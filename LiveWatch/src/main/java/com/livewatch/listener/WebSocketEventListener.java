package com.livewatch.listener;

import com.livewatch.controller.WebSocketController;
...
public class WebSocketEventListener {
    ...
    public WebSocketEventListener(LiveWatchService liveWatchService, WebSocketController webSocketController) {
    ...
    public void handleWebSocketConnectListener(SessionConnectEvent event){
        try {
            ...
            if (sessionId != null) {
                long newCount = liveWatchService.addUserAndGetCount(sessionId);
    ...
    public void handleWebSocketDisconnectListener(SessionDisconnectEvent event) {
        try {
            String sessionId = extractSessionId(event);
            if (sessionId != null) {
                long newCount = liveWatchService.removeUserAndGetCount(sessionId);
                webSocketController.broadcastUserCount((int) newCount);
